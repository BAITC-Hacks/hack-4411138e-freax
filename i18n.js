...
packetLimits:['2–20 DOCX · до 100 МБ каждый · до 200 МБ вместе','2–20 DOCX · әрқайсысы 100 МБ дейін · барлығы 200 МБ дейін','2–20 DOCX · up to 100 MB each · 200 MB total'],
...
packetSizeError:['Общий размер пакета превышает 200 МБ.','Пакеттің жалпы көлемі 200 МБ-тан асты.','The packet exceeds 200 MB in total.'],
...
Object.assign(entries,{
 ...
 "changesIntro": [
  "TeleDoc группирует предварительные выводы, чтобы вы могли проверить смысл изменений.",
  "TeleDoc өзгерістердің мағынасын тексеру үшін алдын ала қорытындыларды топтайды.",
  "TeleDoc groups preliminary findings so you can examine what changed in practice."
 ],
 "changeUnits": [
 ...
 "faqFilesAnswer": [
  "Рабочий экран принимает 2–20 DOCX, до 100 МБ каждый и 200 МБ суммарно. PDF доступен в отдельном серверном исследовательском API, но ещё не подключён к этой форме. OCR и Excel не поддерживаются.",
  "Жұмыс экраны 2–20 DOCX қабылдайды: әрқайсысы 100 МБ, барлығы 200 МБ дейін. PDF бөлек серверлік зерттеу API-де бар, бірақ бұл формаға қосылмаған. OCR және Excel қолдау таппайды.",
  "The workspace accepts 2–20 DOCX, up to 100 MB each and 200 MB total. PDF reading exists in the separate research API but is not connected to this form. OCR and Excel are unsupported."
 ],
 "faqLoss": [
 ...
 "faqDataAnswer": [
  "Файлы отправляются серверу TeleDoc. При включённом ИИ текст передаётся настроенному провайдеру; материалы AI-запуска сохраняются на диске сервера. Подробнее — на странице о данных.",
  "Файлдар TeleDoc серверіне жіберіледі. ЖИ қосылғанда мәтін бапталған провайдерге беріледі; ЖИ сеансының материалдары сервер дискісінде сақталады. Толығырақ — деректер бетінде.",
  "Files go to the TeleDoc server. When AI is enabled, text goes to the configured provider; AI run materials are saved on the server disk. See the data policy."
 ],
 "faqDecision": [
 ...
 "aboutText": [
  "TeleDoc — рабочее место для сопоставления организационной структуры и функций до и после реорганизации. Команда freax соединяет анализ документов с проверкой по первоисточнику.",
  "TeleDoc — қайта ұйымдастыруға дейінгі және кейінгі құрылым мен функцияларды салыстыруға арналған жұмыс орны. freax командасы құжат талдауын түпнұсқадан тексерумен біріктіреді.",
  "TeleDoc is a workspace for comparing organizational structure and responsibilities before and after reorganization. The freax team connects document analysis with source review."
 ],
 "aboutLimits": [
 ...
 "dataUploadText": [
  "После запуска файлы DOCX передаются серверу TeleDoc через /api/analyze. В режиме правил сервер извлекает текст и сравнивает его без обращения к модели.",
  "Іске қосылғаннан кейін DOCX файлдары /api/analyze арқылы TeleDoc серверіне жіберіледі. Ереже режимінде сервер мәтінді шығарып, модельсіз салыстырады.",
  "On submission, DOCX files are sent to the TeleDoc server through /api/analyze. Rules mode extracts and compares text without calling a model."
 ],
 "dataProvider": [
  "Обращение к модели",
  "Модельге сұрау",
...
Object.assign(entries,{
 "tabTitle": [
  "TeleDoc — анализ документов",
  "TeleDoc — құжаттарды талдау",
  "TeleDoc — document analysis"
 ],
 "findingsBadge": [
  "Замечания · {count}",
  "Ескертулер · {count}",
...
Object.assign(entries,{
 ...
 "dataUploadText": [
  "После нажатия «Начать анализ» файлы DOCX передаются серверу TeleDoc. Он извлекает текст и сравнивает документы. Для сравнения формулировок внешний сервис не требуется.",
  "«Талдауды бастау» батырмасын басқан соң DOCX файлдары TeleDoc серверіне жіберіледі. Ол мәтінді шығарып, құжаттарды салыстырады. Тұжырымдарды салыстыру үшін сыртқы қызмет қажет емес.",
  "After you select Start analysis, DOCX files are sent to the TeleDoc server. It extracts text and compares documents. Wording comparison does not require an external service."
 ],
 "dataStorageText": [
...
Object.assign(entries,{
 ...
 packetLimits:['2–20 DOCX · до 100 МБ каждый · до 200 МБ вместе','2–20 DOCX · әрқайсысы 100 МБ дейін · барлығы 200 МБ дейін','2–20 DOCX · up to 100 MB each · up to 200 MB total'],
 researchLimits:['Исследование: до 10 МБ на файл и 40 МБ на комплект.','Зерттеу: файлға 10 МБ, жинаққа 40 МБ дейін.','Research: up to 10 MB per file and 40 MB per set.'],
 chatSetupRequired:['Модель чата не настроена. Заполните .env по README и перезапустите сервер через run.ps1 или run.sh.','Чат моделі бапталмаған. README бойынша .env толтырып, серверді run.ps1 немесе run.sh арқылы қайта іске қосыңыз.','Chat model is not configured. Fill in .env following the README and restart with run.ps1 or run.sh.'],
 ...
 researchHint:['Экспериментальный режим: DOCX и текстовый PDF, до 40 МБ на комплект. Укажите «До» и «После». Текст передаётся модели и сервису эмбеддингов; качество требует проверки аналитиком.','Эксперимент: DOCX және мәтіндік PDF, жинаққа 40 МБ дейін. «Дейін» және «Кейін» таңдаңыз. Мәтін модельге және эмбеддинг сервисіне жіберіледі; нәтижені талдаушы тексереді.','Experimental: DOCX and text PDF, up to 40 MB per set. Assign Before and After. Text is sent to the model and embedding provider; results need analyst review.'],
...
Object.assign(entries,{
 dataProviderText:[
  'При смысловом анализе текст документов отправляется провайдеру, настроенному администратором сервиса. Условия обработки зависят от этого провайдера.',
  'Мағыналық талдау кезінде құжат мәтіні қызмет әкімшісі баптаған провайдерге жіберіледі. Өңдеу шарттары осы провайдерге байланысты.',
...
Object.assign(entries,{
 documentAdded:['Документ добавлен','Құжат қосылды','Document added'],
 documentsAdded:['Добавлено документов: {count}','Қосылған құжаттар: {count}','Documents added: {count}'],
 uploadSelectionNote:['Документы добавлены и готовы к отправке. Обработка начнётся после нажатия «Начать анализ».','Құжаттар қосылды және жіберуге дайын. Өңдеу «Талдауды бастау» батырмасын басқаннан кейін басталады.','Documents are added and ready to send. Processing begins when you select Start analysis.'],
 uploadBytes:['{size} Б','{size} Б','{size} B'],uploadKB:['{size} КБ','{size} КБ','{size} KB'],uploadMB:['{size} МБ','{size} МБ','{size} MB']
});
const enumEntries={
