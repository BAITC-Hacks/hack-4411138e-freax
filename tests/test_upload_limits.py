...
class UploadLimitTests(unittest.TestCase):
    ...
    def test_decoded_size_rejects_one_byte_over_limit(self):
        ...
        with patch.object(server, 'MAX_UPLOAD_BYTES', 8), patch.object(server, 'MAX_ENCODED_FILE_BYTES', 12), patch('server.parse_docx') as parser:
    ...
    def test_total_packet_limit_is_enforced_before_parsing(self):
        ...
        with patch.object(server, 'MAX_PACKET_BYTES', 1), patch('server.parse_docx') as parser:
