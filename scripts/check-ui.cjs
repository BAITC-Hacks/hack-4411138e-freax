...
(async () => {
  ...
  const setLanguage=async lang=>{await page.locator('#workspace-controls [data-language-toggle]').click();await page.locator('#workspace-controls [data-language-choice="'+lang+'"]').click();};
  const errors=[];
